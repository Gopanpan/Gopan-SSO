//常量
var dataUrl = webConfig.webUrl+'/getSysUserPageList',
...
function initJqgrid() {
    $(grid_selector).jqGrid({
        ...
        //显示的标题
        colNames: ['用户Id','用户名', '创建时间','更新时间', '操作'],
            ...
            },
            {
                ...
                formatter: function (x,y,z) {
                    return '<a class="btn btn-primary btn-xs" onclick="sysUserDetail(\''+x+'\');">详情</a> ' +
                        ...
                        '<a class="btn btn-primary btn-xs" onclick="deleteSysInfo(\''+x+'\',\''+z['userName']+'\');">删除</a>';
                }
            }
        ],
...
function andOrupdateSysUser(sysUserId) {
    ...
    parent.layer.open({
        ...
        area: ['768px', '300px'],
        content: webConfig.webUrl + '/manager/sysUser?sysUserId=' + sysUserId,
        end: function () {
            reload();
        }
    });
